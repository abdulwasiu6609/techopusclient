export default function AboutPage(){
    return(
        <div className="pages">
            ...
            <p>But TechOpus is more than just a blog. It's a vibrant community where tech enthusiasts can connect, share ideas, and collaborate. We encourage you to join the conversation by leaving comments, engaging in discussions, and contributing your unique perspectives. Together, we can foster a supportive and inclusive environment where knowledge is shared, and new friendships are forged.</p>
            <p>As technology continues to reshape our world, TechOpus will be there, at the forefront, to keep you informed and inspired. Whether you're seeking the latest updates on emerging technologies or looking for practical tips to enhance your digital life, our commitment to providing high-quality, relevant content remains unwavering.</p>
            <p>Thank you for visiting TechOpus. We invite you to explore our articles, join our community, and embark on a thrilling journey through the ever-evolving world of technology.</p>
            <p>Welcome aboard!</p>
            <p>The TechOpus Team</p>
